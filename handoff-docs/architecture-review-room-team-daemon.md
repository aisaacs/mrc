...
### LOW
- **D3 — `room.json` load has no try/catch** (rooms.js:46/53/61); one torn file throws the whole `listRooms` enumeration (and 500s dashboard requests via knownRoom→listRooms→loadRoom).
